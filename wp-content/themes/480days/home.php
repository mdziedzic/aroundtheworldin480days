<?php get_header(); ?>
					...
					<div id="content"><div id="content-home">
						...
						<div id="cont-container">
							...
							<h2>A 34-country, 480-day, 30,000-mile gallivanting gallimaufry featuring dubious transport through untold landscapes, a standoff or two (or three) with the locals, a drunk role-player, a circus bear, and at least one dangerously caffeinated monkey. And probably a bit too much of the regional beer.<sup>&Dagger;</sup> Oh, and lots of mosquitos. Along the way we took some <a href="https://www.flickr.com/photos/aroundtheworldin480days/sets/" title="Photos">photos</a> (here are some of our <a href="http://www.flickr.com/photos/aroundtheworldin480days/sets/72157624185440774/" title="Favorite photos">favorites</a>).</h2>
							<div class="text-break">
								<img src="<?php bloginfo('template_url'); ?>/images/content/text-break.png" width="78" height="18" alt="Text break" />
							</div>
							<p class="body-text-first-home"><sup>&dagger;</sup>And a few bits of river and sea, but really, almost entirely by land.</p>
							...
							<br/>
							<p class="body-text-first-home"><sup>&Dagger;</sup>Wine, whisky, vodka, mead, waragi, arak, betel, kef, tej...</p>
